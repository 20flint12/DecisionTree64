...
#     "1773146223:AAHiWcIJn-V5x_qgqOeKyCa1_dZK47vGwi8").build()  # FriendDetectorBiblyka_bot
...
async def reply_photo(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    await update.message.reply_photo(photo=open("user_photo.jpg", 'rb'))
...
def main() -> None:
    ...
    application = Application.builder().token("1773146223:AAHiWcIJn-V5x_qgqOeKyCa1_dZK47vGwi8").build()  # FriendDetectorBiblyka_bot
